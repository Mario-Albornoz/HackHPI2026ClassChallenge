...
class GSA_Block(nn.Module):
    ...
    def __init__(self, inplanes, outplanes):
        ...
        self.conv_1_h = nn.Conv2d(
            inplanes, midplanes, kernel_size=(3, 1), padding=(1, 0)
        )
        self.conv_1_w = nn.Conv2d(
            inplanes, midplanes, kernel_size=(1, 3), padding=(0, 1)
        )
...
class TANet(nn.Module):
    ...
    def __init__(self, in_size=3, out_size=3):
        ...
        self.conv_1 = nn.Conv2d(
            in_size, 32, kernel_size=3, stride=1, padding=1
        )  # input
        self.relu_1 = nn.LeakyReLU(0.2, True)
        self.conv_2 = nn.Conv2d(
            32, out_size, kernel_size=3, stride=1, padding=1
        )  # output
        self.relu_2 = nn.LeakyReLU(0.2, True)
